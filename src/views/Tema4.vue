  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
    ...
    .row.mb-5
      ...
      .col-12.col-md-8(data-aos="fade-left")
        ...
        .row
          .col-12.col-md-1
            figure
              img.d-none.d-md-flex(src='@/assets/componentes/btv.svg', alt='Texto que describa la imagen')
          .col-12.col-md-11
    ...
    AcordionA(tipo="a" clase-tarjeta="tarjeta tarjeta--azul")(data-aos="zoom-in-up")
      ...
      .row(titulo="Ejemplo de CRM Móviles")
        ...
        .col-12.col-md-4
          figure
            img(src='@/assets/curso/tema4/t4-16.png', alt='Texto que describa la imagen')
